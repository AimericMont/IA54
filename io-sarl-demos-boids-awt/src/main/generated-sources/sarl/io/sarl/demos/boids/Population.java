...
public class Population {
  ...
  public static final int DEFAULT_SEPARATION_FORCE = 1;
  
  public static final double DEFAULT_COHESION_FORCE = 0.0001;
  
  public static final double DEFAULT_ALIGNMENT_FORCE = 1.0;
  
  public static final int DEFAULT_REPULSION_DIST = 8;
  
  public static int DEFAULT_SEPARATION_DIST = 5;
  
  public static final double DEFAULT_COHESION_DIST = 100.0;
  
  public static final double DEFAULT_ALIGNMENT_DIST = 100.0;
  
  public static final int DEFAULT_BOIDS_NB = 120;
  
  public static final double CAS_CONTACT = 14.5;
  ...
  public Population(final Color col, final int n) {
    ...
    this.mass = 1.0;
    this.distContact = Population.CAS_CONTACT;
  ...
  public boolean equals(final Object obj) {
    ...
    if (Double.doubleToLongBits(other.mass) != Double.doubleToLongBits(this.mass))
      return false;
    if (Double.doubleToLongBits(other.distContact) != Double.doubleToLongBits(this.distContact))
      return false;
  ...
  public int hashCode() {
    ...
    result = prime * result + Double.hashCode(this.distContact);
